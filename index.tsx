...
const durationValueEl = document.querySelector('#duration-value') as HTMLSpanElement;
...
durationSlider.addEventListener('input', () => {
  ...
  durationValueEl.textContent = duration.toString();
});
...
async function generate() {
  ...
  try {
    await generateContent(prompt, base64data, apiKey, aspectRatio, duration);
    statusEl.innerText = '';
  } catch (e) {
